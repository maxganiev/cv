...
export const projectItemsList = [
	...
	[
		...
		new Project(
			...
			'Этот конфигуратор - один из множества в серии, его функционал отражается в названии: с его помощью вы можете сконфигурировать высоковольтный двигатель и сохранить результат в PDF. В серии также присутствуют конфигураторы для других типов электродвигателей, а также для насосов, шкафов управления и т.п.',
			'https://beta.elcomspb.ru/tool/highvolt_conf',
			'hvm',
			['landscape', 'portrait'],
			['SvelteKit', 'Prisma']
